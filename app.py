...
/* Make photo/video choices immediately distinguishable without making either loud. */
#live-camera-start {
  border-color: #2f855a;
  background: rgba(47, 133, 90, .11);
}
#live-camera-start:hover,
#live-camera-start:focus-visible {
  background: rgba(47, 133, 90, .17);
}
.video-menu-button {
  border-color: #7c3aed;
...
.video-menu-button:focus-visible {
